const { dataPath, readJsonFile, writeJsonFile, writeJsonFileAsync } = require("./data-dir");
  ...
  function persistSoon() {
    ...
    saveTimer = setTimeout(() => {
      ...
      writeJsonFileAsync(STATE_FILE(), {
        ...
        savedAt: Date.now(),
      }).catch((e) => console.error(`paper-bot persist failed: ${e.message || e}`));
    }, 400);
  }
