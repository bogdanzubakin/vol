...
function createLiveBot(options = {}) {
  ...
  function ensureDrawdownBaseline() {
    ...
    pushLog(
      "DRAWDOWN",
      "—",
      `Baseline $${ref.toFixed(2)} on bot trades (max loss −${state.config.drawdownStopPct}%)`
    );
    persistSoon();
  }
