...
/** Base + Binance funding rate and open-interest deltas (v3 signal model). */
...
function extractPullbackSignalFeatures(bars, extras = {}) {
  ...
  return {
    ...
    _fundingRateRaw: fundingOiFeat._fundingRateRaw,
    _fundingTrendRaw: fundingOiFeat._fundingTrendRaw,
    _oiDelta1hRaw: fundingOiFeat._oiDelta1hRaw,
  };
}
